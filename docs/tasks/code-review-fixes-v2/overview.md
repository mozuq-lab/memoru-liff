...
- [x] Phase 2: High修正（セキュリティ + レスポンスDTO + 通知 + 設定統一）
...
- [x] [TASK-0045: レスポンスDTO統一 + unlinkLine API使用](TASK-0045.md) - 8h (TDD) 🔵
- [x] [TASK-0046: 通知時刻/タイムゾーン判定](TASK-0046.md) - 8h (TDD) 🔵
- [x] [TASK-0047: 設定整合性統一（環境変数名・OIDCクライアントID）](TASK-0047.md) - 4h (DIRECT) 🔵
